...
<body>
  <div id="app">
      ...
      <div class="main-content">
        <section class="section">
            <div class="section-header">
              ...
              <div class="breadcrumb-item active"><a href="petugas_tambah.php">Tambah Petugas</a></div>
                </div>
            </div>
    ...
    move_uploaded_file($gambar['tmp_name'],'images/'.$gambar['name']);
                  ...
                  $query = mysqli_query($koneksi, "INSERT INTO petugas(nama_petugas,username,password,alamat,level,gambar) VALUES('$nama_petugas','$username','$password','$alamat', '$level','$nama_gambar')");
                ...
                ?>
                        ...
                        <label style="font-size: 13px; font-weight:bold;">Foto Profile :</label>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" name="nama_petugas">
                      </div>
                      <div class="form-group">
