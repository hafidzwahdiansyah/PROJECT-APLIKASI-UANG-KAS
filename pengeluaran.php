      ...
      <div class="main-content">
        <section class="section">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item"><a href="pengeluaran.php">Pengeluaran</a></div>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                ...
                <div class="table-responsive">
                  <a href="pengeluaran_tambah.php" class="btn btn-primary"><i class="fas fa-plus"  ></i> Tambah Data</a><br><br>
                      <table class="table table-striped" id="table-1">
                        <thead style="background-color: #6777ef;">                                 
                          <tr>
                            <th style="color:#ffff;">No</th>
                            <th style="color:#ffff;">Petugas</th>
                            <th style="color:#ffff;">Jumlah Pengeluaran</th>
                            <th style="color:#ffff;">Tanggal Pengeluaran</th>
                            <th style="color:#ffff;">Keterangan</th>
                      ...
                      <td>
                         <a  href="pengeluaran_ubah.php?id=<?php echo $data['id_pengeluaran']; ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
                       </td>
                       <?php
                       $i++;
                     }
