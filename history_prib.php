         ...
         <?php
          ...
          ?>
           <?php
            ...
            <li class="dropdown">
              <a href="laporan.php" class="nav-link"><i class="fas fa-history"></i><span>Laporan</span></a>
            </li>
            <?php 
          }
          ?>
      ...
      <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>History Pembayaran Uang Kas Anda</h1>
                <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="#" style="color: grey;">Dashboard</a></div>
              <div class="breadcrumb-item active"><a href="history_prib.php">History</a></div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <th style="color: white;">Jumlah Bayar</th>
                        <?php
                         $where = " WHERE pemasukan.id_anggota=" . $_SESSION['user']['id_anggota'];
                       ...
                       <?php
                      $i =1;
                      $query = mysqli_query($koneksi,"SELECT*FROM pemasukan left join anggota on anggota.id_anggota=pemasukan.id_anggota $where");
