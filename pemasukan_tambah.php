      ...
      <div class="main-content">
        <section class="section">
            <div class="section-header">
              ...
              <div class="breadcrumb-item active"><a href="pemasukan_tambah.php">Tambah Pemasukan</a></div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            if(isset($_POST['submit'])) {
                ...
                $query = mysqli_query($koneksi, "INSERT INTO pemasukan(id_petugas,id_anggota,tanggal_pemasukan,nominal)
                values ('$id_petugas','$id_anggota','$tanggal_pemasukan','$nominal')");
            ...
            ?>
                      ...
                      <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Tanggal :</label>
                        <input type="date" class="form-control" required="" name="tanggal_pemasukan">
                      </div>
                      <div class="form-group">
