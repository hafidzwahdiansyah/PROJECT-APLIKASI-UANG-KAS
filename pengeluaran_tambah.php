      ...
      <div class="main-content">
        <section class="section">
            <div class="section-header">
              ...
              <div class="breadcrumb-item active"><a href="pengeluaran_tambah.php">Tambah Pengeluaran</a></div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            if(isset($_POST['submit'])) {
                ...
                $query = mysqli_query($koneksi, "INSERT INTO pengeluaran(id_petugas,jmlh_pengeluaran,tanggal_pengeluaran,keterangan)
                values ('$id_petugas','$jmlh_pengeluaran','$tanggal_pengeluaran','$keterangan')");
            ...
            ?>
                      ...
                      <input type="text" class="form-control" required="" name="jmlh_pengeluaran">
                      </div>
                      <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Tanggal Pengeluaran :</label>
                        <input type="date" class="form-control" required="" name="tanggal_pengeluaran">
                      </div>
                      <div class="form-group">
