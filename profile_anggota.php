      ...
      <div class="main-content">
        <section class="section">
            <div class="section-header">
              ...
              <div class="breadcrumb-item active"><a href="profile_anggota.php">Profile</a></div>
                </div>
            </div>
...
if (isset($_POST['username'])) {
  ...
  $password = md5($_POST['password']);
    ...
    if ($nama_gambar != "") {
        ...
        $query = mysqli_query($koneksi, "UPDATE anggota SET gambar='$nama_gambar' WHERE id_anggota=$id");
    }

  $query = mysqli_query($koneksi, "UPDATE anggota SET username='$username', nama_anggota='$nama_anggota', alamat='$alamat' WHERE id_anggota=$id");

  if($_POST['password'] != "") {
    $query = mysqli_query($koneksi, "UPDATE anggota set password='$password' WHERE id_anggota=$id");
    echo '<script>location.href="profile_anggota.php"</script>';
  }
    if($query){
