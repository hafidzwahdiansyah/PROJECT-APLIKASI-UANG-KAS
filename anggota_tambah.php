      ...
      <div class="main-content">
        <section class="section">
            <div class="section-header">
              ...
              <div class="breadcrumb-item active"><a href="anggota_tambah.php">Tambah Anggota</a></div>
                </div>
            </div>
            ...
            <div class="col-12">
                ...
                ?>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" name="nama_anggota">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Level :</label>
                         <input type="text" class="form-control" required="" name="level" value="anggota">
