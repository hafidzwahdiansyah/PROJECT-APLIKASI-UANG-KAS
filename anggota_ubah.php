      ...
      <div class="main-content">
        <section class="section">
            <div class="section-header">
              ...
              <div class="breadcrumb-item active"><a href="petugas_ubah.php">Ubah Anggota</a></div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                    <a href="anggota.php" class="btn btn-primary" style="font-weight: bold;">Kembali</a> <br><br>
                ...
                if (isset($_POST['nama_anggota'])) {
                  ...
                  $query = mysqli_query($koneksi, "UPDATE anggota SET nama_anggota='$nama_anggota', username='$username', alamat='$alamat'
                   WHERE id_anggota=$id");

                  if ($_POST['password'] != "") {
                  $query = mysqli_query($koneksi, "UPDATE anggota SET password='$password' WHERE id_anggota=$id");
                  }
                ...
                ?>
                     <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" name="nama_anggota" value="<?php echo $data['nama_anggota'];?>">
                      </div>
                      <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Alamat :</label>
                        <input type="text" class="form-control" required="" name="alamat" value="<?php echo $data['alamat'];?>">
                      </div>
