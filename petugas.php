      ...
      <div class="main-content">
        <section class="section">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item"><a href="petugas.php">Petugas</a></div>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                ...
                <div class="table-responsive">
                  <a href="petugas_tambah.php" class="btn btn-primary"><i class="fas fa-plus"  ></i> Tambah Data</a><br><br>
                      <table class="table table-striped" id="table-1">
                        <thead style="background-color: #6777ef;">                                 
                          <tr>
                            ...
                            <th style="color:#ffff;">Nama Petugas</th>
                      ...
                      <tr>
                       ...
                       <td>
              <a  href="petugas_ubah.php?id=<?php echo $data['id_petugas']; ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
              <a  onclick="return confirm('Apakah Anda Yakin Menghapuds Data Ini?');" href="petugas_hapus.php?id=<?php echo $data['id_petugas']; ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                       </td>
                       <?php
                       $i++;
                     }
