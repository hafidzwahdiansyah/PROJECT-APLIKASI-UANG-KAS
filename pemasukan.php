      ...
      <div class="main-content">
        <section class="section">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item"><a href="pemasukan.php">Pemasukan</a></div>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                ...
                <div class="table-responsive">
                  <a href="pemasukan_tambah.php" class="btn btn-primary"><i class="fas fa-plus"  ></i> Tambah Data</a><br><br>

                      <table class="table table-striped" id="table-1">
                        <thead style="background-color: #6777ef;">                                 
                          <tr>
                            <th style="color:#ffff;">No</th>
                            <th style="color:#ffff;">Petugas</th>
                            <th style="color:#ffff;">Nama Anggota</th>
                            <th style="color:#ffff;">Tanggal</th>
                            <th style="color:#ffff;">Jumlah Bayar</th>
                       ...
                       <?php
                      $i =1;
                      $query = mysqli_query($koneksi,"SELECT*FROM pemasukan left join petugas on petugas.id_petugas=pemasukan.id_petugas left join anggota on anggota.id_anggota=pemasukan.id_anggota");
                      ...
                      <tr>
                       ...
                       <td>Rp. <?php echo number_format( $data['nominal']);?></td>
                          <td>
                         <a  href="pemasukan_ubah.php?id=<?php echo $data['id_pemasukan']; ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
                       </td>
                       <?php
                       $i++;
                     }
