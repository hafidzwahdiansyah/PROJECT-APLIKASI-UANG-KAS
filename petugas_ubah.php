      ...
      <div class="main-content">
        <section class="section">
            <div class="section-header">
              ...
              <div class="breadcrumb-item active"><a href="petugas_ubah.php">Ubah Petugas</a></div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                    <a href="petugas.php" class="btn btn-primary" style="font-weight: bold;">Kembali</a> <br><br>
                ...
                if (isset($_POST['nama_petugas'])) {
                  ...
                  $query = mysqli_query($koneksi, "UPDATE petugas SET nama_petugas='$nama_petugas', username='$username', alamat='$alamat', level='$level'
                   WHERE id_petugas=$id");
                ...
                ?>
                     <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" name="nama_petugas" value="<?php echo $data['nama_petugas'];?>">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Level :</label>
